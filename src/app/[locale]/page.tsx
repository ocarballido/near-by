        ...
        <>
            <main className="bg-white">
                ...
                <section
                    ...
                    className="bg-white flex flex-col gap-8 justify-center items-center pt-3"
                >
                    <BadgeMarketing
                        className="px-4"
            ...
            <div className="roboto flex flex-col items-center py-4 gap-2">
                <nav className="px-4 w-full">
                    <LandingAppBar className="max-w-7xl mx-auto" />
                </nav>
                <section className="px-4 w-full">
                    <div
                        aria-labelledby="BNB-explorer"
                        className="bg-primary-200 rounded-lg px-0 py-12 md:py-18 min-h-[600px] md:min-h-[800px] lg:min-h-[900px] relative flex w-full"
                    >
                ...
                <section
                    aria-labelledby="why"
                    className="flex flex-col gap-8 rounded-lg py-16 items-center max-w-7xl px-4 mx-auto relative"
                >
                    <Image
                        src={blur}
                        fill={true}
                ...
                <section className="px-4 max-w-7xl w-full">
                    <div
                        ...
                        className="flex flex-col md:flex-row justify-center items-center rounded-xl px-4 relative overflow-hidden bg-gradient-to-t from-[#84E1BC] to-[#265EF8]"
                    >
                        <div className="flex flex-col-reverse lg:flex-row gap-4 items-stretch max-w-[1000px]">
                            <div className="flex flex-col gap-6 text-white px-6 py-6 lg:py-20 justify-center">
                                <FancyBadge
                                    firstText={t(
                                        "page_home.section_reade_to_go.badge",
                                    )}
                                />
                                <h2
                                    id="features"
                                ...
                                <h3 className="text-3xl">
                                    {t(
                                        "page_home.section_reade_to_go.subtitle",
                                    )}
                                </h3>
                                ...
                                <div className="flex flex-wrap gap-1">
                                    ...
                                    />
                                    <BadgeCheck
                                        label={t("Supermercados")}
                                        checked
                                    />
                                    <BadgeCheck
                                        label={t(
                                            "section_ready_to_go.and_more_badge",
                                        )}
                                        checked
                                    />
                                </div>
                ...
                <section
                    aria-labelledby="how"
                    className="flex flex-col gap-8 rounded-lg py-16 px-4 text-center items-center max-w-7xl w-full mx-auto relative"
                >
                    <Image
                        src={blur}
                        fill={true}
                    ...
                    <div className="grid grid-cols-1 grid-rows-1 sm:grid-cols-2 sm:grid-rows-2 gap-2 max-w-5xl w-full">
                        <Feature
                            color="gradient"
                            number={1}
                            ...
                            <div className="flex flex-col md:flex-row items-stretch">
                                <div className="flex-1 flex flex-col justify-center gap-4 py-8 relative">
                                    ...
                                    <p className="font-body font-medium opacity-70 pr-6 pl-4">
                                        {t(
                                            "page_home.section_features.bodyFeatureOne",
                                        )}
                                    </p>
                                    <ButtonLink
                                        label={t("page_home.mainAction")}
                ...
                <section
                    ...
                    className="flex flex-col gap-8 rounded-lg px-4 py-12 items-center max-w-[1400px] ml-auto mr-auto"
                >
                        ...
                        <div className="w-full flex flex-col items-center">
                            <div className="flex flex-col gap-2 sm:flex-row items-center">
                                <Quote
                                    ...
                                    body={t(
                                        "page_home.section_quotes.quote1Body",
                                    )}
                                    person={t(
