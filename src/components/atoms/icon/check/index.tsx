...
const IconCheck = ({ color = "body", size = 24, className }: IconProps) => {
    ...
    return (
        ...
        >
            ...
            <g mask="url(#mask0_3_663)">
                <path d="M9.55001 18L3.85001 12.3L5.27501 10.875L9.55001 15.15L18.725 5.97498L20.15 7.39998L9.55001 18Z" />
            </g>
        </svg>
    );
};
