        ...
        <div className="flex flex-col gap-3 w-full">
            ...
            {groups.map((group) => {
                ...
                return (
                    ...
                    >
                        <button
                            className="w-full flex items-center justify-between px-4 py-4 font-medium text-left hover:bg-primary-100 hover:cursor-pointer transition-colors duration-200"
                            onClick={() =>
