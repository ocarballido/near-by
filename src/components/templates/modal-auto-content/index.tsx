...
// 	// Cancel/cierre manual: recordar en sessionStorage
// 	const dismiss = () => {
// 		setDismissed(true);
// 		sessionStorage.setItem(storageKey, '1');
// 	};

// 	// Success: cerrar sin re-escribir sessionStorage
// 	const closeForSessionOnly = () => {
// 		setDismissed(true);
// 	};
...
// 	const RECOMMENDED_OPTIONS: Option[] = useMemo(
// 		() => [
// 			{
// 				subCategoryId:
// 					CATEGORIES_SUB_CATEGORIES.SHOPPING.SUB_CATEGORIES
...
// 	const OPTIONAL_OPTIONS: Option[] = useMemo(
// 		() => [
// 			{
// 				subCategoryId:
// 					CATEGORIES_SUB_CATEGORIES.SECURITY_AND_EMERGENCIES
...
// 						.HOSPITALS.id,
// 				name: CATEGORIES_SUB_CATEGORIES.HEALTH_AND_WELLNESS
// 					.SUB_CATEGORIES.HOSPITALS.name,
// 			},
// 		],
// 		[]
// 	);

// 	// Selección inicial: recomendados
// 	const [selectedSubCategoryIds, setSelectedSubCategoryIds] = useState<
// 		string[]
// 	>(() => RECOMMENDED_OPTIONS.map((x) => x.subCategoryId));

// 	// Seguridad por hidratación: si por lo que sea queda vacío, restablecer recomendados
// 	useEffect(() => {
// 		setSelectedSubCategoryIds((prev) =>
// 			prev.length ? prev : RECOMMENDED_OPTIONS.map((x) => x.subCategoryId)
// 		);
// 	}, [RECOMMENDED_OPTIONS]);
...
// 		setAlert({ type: 'success', message: t('auto-modal-success-message') });

// 		// ✅ success: limpiar storage para no dejar estado “fantasma”
// 		sessionStorage.removeItem(storageKey);

// 		// ✅ cerrar sin re-escribir storage
// 		closeForSessionOnly();

// 		router.refresh();
// 	};

// 	// Mantener vivo el componente si hay alert (para que se vea)
// 	const shouldRender = open || alert !== null;
// 	if (!shouldRender) return null;
...
// 				<Modal
// 					title={t('auto-modal-title')}
// 					description={t.rich('auto-modal-description', {
// 						bold: (chunks) => (
// 							<span className="font-bold">{chunks}</span>
// 						),
// 					})}
...
// 							{t('auto-modal-recommended-title')}
// 						</p>
// 						<p className="text-xs text-gray-600 mb-3">
// 							{t('auto-modal-recommended-description')}
// 						</p>
...
// 						<p className="text-sm font-bold text-gray-900 mb-1">
// 							{t('auto-modal-optional-title')}
// 						</p>
// 						<p className="text-xs text-gray-600 mb-3">
// 							{t('auto-modal-optional-description')}
// 						</p>
