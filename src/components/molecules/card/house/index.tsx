...
const House = ({
    ...
    return (
        <div
            className={`group relative flex flex-col justify-end rounded-xl overflow-hidden min-h-[400px] pt-[180px] shadow-xs bg-gradient-to-tr from-[#ffa263] to-[#6cffc9] ${className}`}
        >
            <Image
