...
export default function PlaceAutocompleteField({
    ...
    useEffect(() => {
        ...
        // Sin este .catch(), un rechazo de waitForGoogleMapsReady() (timeout,
        // falta de API key) quedaba como unhandled rejection: el usuario veía
        // el campo en blanco, sin ningún mensaje de error.
        init().catch((err) => {
            console.error("[PlaceAutocompleteField] init() falló:", err);
            setInternalError(helperTextError ?? "");
        });
