...
import { findSubCategoryNameById } from "@/lib/places/subcategory-lookup";
...
const MagicFinderForm = ({
    ...
    const subCategoryName = findSubCategoryNameById(subCategoryId);
    const translatedSubCategoryName = subCategoryName
        ? t(subCategoryName)
        : null;
            ...
            <div className="rounded-lg p-3 pt-0 flex flex-col gap-2 items-center">
                ...
                <Typography component="h2" size="lg">
                    {translatedSubCategoryName
                        ? t("magic-finder-title-with-name", {
                              name: translatedSubCategoryName,
                          })
                        : t("Buscador mágico")}
                </Typography>
                <div className="p-4 bg-primary-50 rounded-md">
                    <Typography component="p" size="sm" color="text-gray-600">
                        {translatedSubCategoryName
                            ? t("magic-finder-description-with-name")
                            : t(
