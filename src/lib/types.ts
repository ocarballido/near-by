...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      categories: {
        Row: {
          ...
          name: string
          order_index: number
          type: Database["public"]["Enums"]["property_data_type"] | null
        }
        Insert: {
          created_at?: string | null
          icon?: string | null
      ...
      chatbot_daily_usage: {
        ...
        Relationships: [
          {
            foreignKeyName: "chatbot_daily_usage_property_id_fkey"
            columns: ["property_id"]
            isOneToOne: false
      ...
      property_data_translations: {
        ...
        Relationships: [
          {
            foreignKeyName: "property_data_translations_property_data_id_fkey"
    ...
    Functions: {
      ...
      increment_ai_monthly_cost: {
        Args: { p_amount_usd: number; p_property_id: string }
        Returns: {
          global_cost_usd: number
          property_cost_usd: number
        }[]
      }
      increment_chatbot_daily_usage: {
        Args: { p_anon_id: string; p_property_id: string }
        Returns: number
      }
    }
    Enums: {
