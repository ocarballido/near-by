-- Baseline schema snapshot (from production)
-- This migration must run BEFORE any incremental migrations.
-- If you need to refresh the baseline, regenerate schema.sql from prod
-- and replace the content of this file.

-- ---------------------------------------------------------
-- Ensure required extensions exist (common in Supabase)
-- ---------------------------------------------------------
...
-- ---------------------------------------------------------
-- Production schema dump (schema.sql)
-- ---------------------------------------------------------
