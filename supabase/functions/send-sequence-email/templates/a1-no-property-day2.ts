...
const MESSAGES: Record<Locale, Copy> = {
    ...
    pt: {
        subject: "O seu guia digital está à sua espera",
        preheader: "Crie o seu primeiro alojamento em menos de 3 minutos.",
        title: "Ainda não criou o seu primeiro alojamento",
        body1: "Registou-se no BNBexplorer mas ainda não adicionou nenhum alojamento. Só precisa de um nome e uma morada para começar.",
        body2: "Em menos de 3 minutos terá um guia digital pronto a partilhar com os seus inquilinos.",
        buttonLabel: "Criar o meu primeiro alojamento",
        footerUnsubscribe: "Não quero receber mais e-mails",
        footerIgnore: "Se não reconhece este e-mail, pode ignorá-lo.",
    },
    it: {
        subject: "La tua guida digitale ti aspetta",
        preheader: "Crea il tuo primo alloggio in meno di 3 minuti.",
        title: "Non hai ancora creato il tuo primo alloggio",
        body1: "Ti sei registrato su BNBexplorer ma non hai ancora aggiunto nessun alloggio. Ti bastano un nome e un indirizzo per iniziare.",
        body2: "In meno di 3 minuti avrai una guida digitale pronta da condividere con i tuoi ospiti.",
        buttonLabel: "Crea il mio primo alloggio",
