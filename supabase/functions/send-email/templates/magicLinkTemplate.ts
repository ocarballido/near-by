          ...
          <td class="container">
            ...
            <div class="content">
              <div class="btn-span-shadow">
                <a href="${magicLink}" target="_blank" class="btn-primary" style="box-shadow: 0px 0px 0px 4px #F3F4F6; text-decoration: none; display: inline-block; color: white">${copy.buttonLabel}</a>
              </div>
            </div>
            <!-- /Button -->
